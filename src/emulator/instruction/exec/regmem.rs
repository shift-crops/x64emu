...
pub fn get_moffs32(arg: &InstrArg) -> u32 {
    arg.ac.get_data32((SgReg::DS, arg.idata.moffs as u64))
}

pub fn set_moffs32(arg: &mut InstrArg, v: u32) -> () {
    arg.ac.set_data32((SgReg::DS, arg.idata.moffs as u64), v);
}
...
pub fn get_moffs16(arg: &InstrArg) -> u16 {
    arg.ac.get_data16((SgReg::DS, arg.idata.moffs as u64))
}

pub fn set_moffs16(arg: &mut InstrArg, v: u16) -> () {
    arg.ac.set_data16((SgReg::DS, arg.idata.moffs as u64), v);
}
...
pub fn get_moffs8(arg: &InstrArg) -> u8 {
    arg.ac.get_data8((SgReg::DS, arg.idata.moffs as u64))
}

pub fn set_moffs8(arg: &mut InstrArg, v: u8) -> () {
    arg.ac.set_data8((SgReg::DS, arg.idata.moffs as u64), v);
}
