...
impl<'a> super::Exec<'a> {
    pub fn get_imm8(&self) -> Result<u8, ExecException> {
        Ok(self.idata.imm as u8)
    }

    pub fn get_imm16(&self) -> Result<u16, ExecException> {
        Ok(self.idata.imm as u16)
    }

    pub fn get_rm32(&self) -> Result<u32, ExecException> {
    ...
    pub fn set_rm32(&mut self, v: u32) -> Result<(), ExecException> {
        let modrm = self.idata.modrm;
        if modrm.mod_ == 3 {
    ...
    pub fn get_r32(&self) -> Result<u32, ExecException> {
        Ok(get_gpreg!(self, GpReg32, self.idata.modrm.reg))
    }

    pub fn set_r32(&mut self, v: u32) -> Result<(), ExecException> {
        set_gpreg!(self, GpReg32, self.idata.modrm.reg, v);
        Ok(())
    }

    pub fn get_moffs32(&self) -> Result<u32, ExecException> {
        Ok(self.ac.get_data32((SgReg::DS, self.idata.moffs))?)
    }

    pub fn set_moffs32(&mut self, v: u32) -> Result<(), ExecException> {
        self.ac.set_data32((SgReg::DS, self.idata.moffs), v)?;
        Ok(())
    }

    pub fn get_rm16(&self) -> Result<u16, ExecException> {
        let modrm = self.idata.modrm;
        let v = if modrm.mod_ == 3 {
    ...
    pub fn set_rm16(&mut self, v: u16) -> Result<(), ExecException> {
        let modrm = self.idata.modrm;
        if modrm.mod_ == 3 {
    ...
    pub fn get_r16(&self) -> Result<u16, ExecException> {
        Ok(get_gpreg!(self, GpReg16, self.idata.modrm.reg))
    }

    pub fn set_r16(&mut self, v: u16) -> Result<(), ExecException> {
        set_gpreg!(self, GpReg16, self.idata.modrm.reg, v);
        Ok(())
    }

    pub fn get_moffs16(&self) -> Result<u16, ExecException> {
        Ok(self.ac.get_data16((SgReg::DS, self.idata.moffs))?)
    }

    pub fn set_moffs16(&mut self, v: u16) -> Result<(), ExecException> {
        self.ac.set_data16((SgReg::DS, self.idata.moffs), v)?;
        Ok(())
    }

    pub fn get_rm8(&self) -> Result<u8, ExecException> {
        let modrm = self.idata.modrm;
        let v = if modrm.mod_ == 3 {
    ...
    pub fn set_rm8(&mut self, v: u8) -> Result<(), ExecException> {
        let modrm = self.idata.modrm;
        if modrm.mod_ == 3 {
    ...
    pub fn get_r8(&self) -> Result<u8, ExecException> {
        Ok(get_gpreg!(self, GpReg8, self.idata.modrm.reg))
    }

    pub fn set_r8(&mut self, v: u8) -> Result<(), ExecException> {
        set_gpreg!(self, GpReg8, self.idata.modrm.reg, v);
        Ok(())
    }

    pub fn get_moffs8(&self) -> Result<u8, ExecException> {
        Ok(self.ac.get_data8((SgReg::DS, self.idata.moffs))?)
    }

    pub fn set_moffs8(&mut self, v: u8) -> Result<(), ExecException> {
        self.ac.set_data8((SgReg::DS, self.idata.moffs), v)?;
        Ok(())
    }

    pub fn get_m(&self) -> Result<u64, ExecException> {
